...
public class DepositParameterTestFixture {
  ...
  public static final DepositReceiptParameter DEPOSIT_PARAM_1 =
      createDeposit(
          ...
          "0x1");
  static final DepositReceiptParameter DEPOSIT_PARAM_2 =
      createDeposit(
  ...
  private static DepositReceiptParameter createDeposit(
      final String pubKey,
      final String withdrawalCredentials,
      final String amount,
      final String signature,
      final String index) {
    return new DepositReceiptParameter(pubKey, withdrawalCredentials, amount, signature, index);
  }
}
